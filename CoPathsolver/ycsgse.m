%Stationary Equilibrium: Logarithmic Barrier (V1), CY Smoothing
...
for i=1:n
%     scatter(1:20:ni,fs(i,1:20:ni));
%     hold on;
    plot(1:ni,fs(i,1:ni));
axis([1 inf -inf 1]);
hold on;
 end
% scatter(1:20:ni,fs2(1:20:ni));
% hold on;
plot(1:ni,fs2(1:ni));
...
fprintf('Stationary Equilibrium: Logarithmic Barrier (V1) & CY Smoothing\n\n');
